              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="h-[250px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={contributorsData}>
                          <CartesianGrid strokeDasharray="3 3" stroke="#333" />
                          <XAxis dataKey="name" stroke="#666" />
                          <YAxis stroke="#666" />
                          <Tooltip
                            ...
                            labelStyle={{ color: "#fff" }}
                          />
                          <Line type="monotone" dataKey="contributions" stroke="#25a55f" strokeWidth={2} />
                        </LineChart>
                      </ResponsiveContainer>
                    </div>
                  </div>
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          <Tooltip
                            ...
                            labelStyle={{ color: "#fff" }}
                          />
                          <Line type="monotone" dataKey="visitors" stroke="#3498db" strokeWidth={2} />
                        </LineChart>
                      </ResponsiveContainer>
                    </div>
                  </div>
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          <Tooltip
                            ...
                            labelStyle={{ color: "#fff" }}
                          />
                          <Line type="monotone" dataKey="clones" stroke="#e74c3c" strokeWidth={2} />
                        </LineChart>
                      </ResponsiveContainer>
                    </div>
                  </div>
