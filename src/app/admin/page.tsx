...
export default function AdminPage() {
  ...
  let topUsers: Array<{ id: string; name?: string; email?: string; image?: string; totalCost: number; totalTokens: number; byokTokens: number; managedTokens: number; plan?: string; }> = [];
