...
type SearchProfilesOutput = inferRouterOutputs<AppRouter>['profile']['searchProfiles'];
...
interface HireSearchClientProps {
  initialData: SearchProfilesOutput;
}

export default function HireSearchClient({ initialData }: HireSearchClientProps) {
      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        {isLoading ? (
          <div className="space-y-3">
            ...
            <div className="animate-pulse rounded-md bg-gray-200 h-20 w-full" />
            <div className="animate-pulse rounded-md bg-gray-200 h-20 w-full" />
            <div className="animate-pulse rounded-md bg-gray-200 h-20 w-full" />
          </div>
