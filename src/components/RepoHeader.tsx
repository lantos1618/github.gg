  ...
  return (
    <div className="w-[90%] max-w-[800px] mx-auto pt-6 sm:pt-8">
      <div className="mb-8">
        ...
        {/* Title */}
        <h1 data-testid="repo-header-title" className="text-[24px] sm:text-[32px] font-semibold text-[#111] leading-tight mb-1 break-all">
        ...
        <div className="flex items-center gap-4 mt-2 mb-6">
          ...
          {loadingBranches ? (
            ...
            <span className="text-[12px] text-[#ea4335]">{branchError.message || 'Failed to load branches'}</span>
          ) : branches.length > 0 ? (
            <Select
            ...
            >
              <SelectTrigger data-testid="repo-header-branch-select" className="w-[120px] text-[12px] h-8 border-[#ddd]">
    ...
    <div className="mb-8">
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-3">
          <h1 className="text-[22px] font-semibold text-[#111]">{title}</h1>
          {lastUpdated && (
