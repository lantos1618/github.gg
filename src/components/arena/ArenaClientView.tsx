        ...
        {isSignedIn && myRanking && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 py-6 border-y border-[#eee]">
            {[
              ...
              <div key={stat.label}>
                <div className="text-[11px] text-[#aaa] font-semibold tracking-[1px] uppercase mb-1">{stat.label}</div>
        ...
        <div className="min-h-[400px]">
          ...
          {activeTab === 'battle' && (
            canBattle ? (
              ...
              <div className="py-16 text-center">
                <div className="text-[11px] text-[#aaa] font-semibold tracking-[1.5px] uppercase mb-3">Battle</div>
                <h3 className="text-[22px] font-semibold text-[#111] mb-2">Start Battling</h3>
                <p className="text-[13px] text-[#666] mb-8 max-w-md mx-auto">
          ...
          {activeTab === 'history' && (
            canBattle ? (
              ...
              <div className="py-16 text-center">
                <div className="text-[11px] text-[#aaa] font-semibold tracking-[1.5px] uppercase mb-3">History</div>
