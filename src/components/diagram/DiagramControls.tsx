    ...
    <div className="flex items-center justify-between py-3 border-b border-[#eee]">
      <div className="flex items-center gap-2">
        <button
          ...
          disabled={disabled}
          className="px-3 py-1.5 bg-[#f8f9fa] text-[#666] text-base font-medium rounded border border-[#eee] hover:border-[#aaa] hover:text-[#111] transition-colors disabled:opacity-50"
        >
