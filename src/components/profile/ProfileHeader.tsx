    ...
    <div data-testid="profile-header" className="flex gap-6 sm:gap-8">
      ...
      <div className="min-w-0">
        ...
        <a
          ...
          className="text-[28px] sm:text-[36px] font-semibold text-[#111] hover:text-[#666] transition-colors leading-tight block"
        ...
        <div className="flex items-center gap-3 mt-3 flex-wrap">
          ...
          {profile.profileConfidence !== undefined && (
            <div
              className="flex items-center gap-1 text-[12px] text-[#aaa] px-2 py-0.5"
