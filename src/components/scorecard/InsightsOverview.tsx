  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        <div>
          <div className="text-[11px] text-[#aaa] font-semibold tracking-[1px] uppercase mb-1">Total Files</div>
          <div className="text-[28px] font-semibold text-[#111]">{overview.totalFiles.toLocaleString()}</div>
        </div>
        <div>
          <div className="text-[11px] text-[#aaa] font-semibold tracking-[1px] uppercase mb-1">Size</div>
          <div className="text-[28px] font-semibold text-[#111]">{overview.totalSize}</div>
        </div>
        <div>
          <div className="text-[11px] text-[#aaa] font-semibold tracking-[1px] uppercase mb-1">Main Language</div>
          <div className="text-[28px] font-semibold text-[#111]">{overview.mainLanguage}</div>
        </div>
        <div>
          <div className="text-[11px] text-[#aaa] font-semibold tracking-[1px] uppercase mb-1">Complexity</div>
