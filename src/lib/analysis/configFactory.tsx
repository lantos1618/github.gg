...
const ANALYSIS_CONFIGS: Record<AnalysisType, AnalysisTypeConfig> = {
  'scorecard': {
    ...
    generatingButtonText: 'Generate Scorecard',
    loadingMessage: 'Generating scorecard...',
  ...
  'ai-slop': {
    ...
    generatingButtonText: 'Analyze Code Quality',
    loadingMessage: 'Generating code quality report...',
  ...
  'security': {
    ...
    noDataTitle: 'No Vulnerability Scan',
    noDataDescription: 'Profile this repo for vulnerabilities, exposed secrets, and supply-chain risk.',
    privateRepoMessage: 'Vulnerability scans are not available for private repositories.',
    generateButtonText: 'Scan for Vulnerabilities',
    generatingButtonText: 'Scanning...',
    loadingMessage: 'Loading vulnerability scan...',
    generatingMessage: 'Scanning for vulnerabilities...',
    errorMessage: 'Failed to generate vulnerability scan',
    showCopyButton: true,
    showMetricsBar: true,
    useEffectiveRef: true,
